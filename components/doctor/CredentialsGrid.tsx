...
const credSections = (doctor: DoctorInfo, clinic: ClinicInfo) => [
  ...
  { num: '10', grad: 'linear-gradient(135deg,var(--primary),var(--primary-dark))', title: 'Consultation Details', sub: 'Languages & Availability', items: [{ title: 'Languages', sub: doctor.languages.join(' · ') }, { title: 'Second Opinion', sub: 'Available -- bring all previous reports.' }, { title: 'Online Consultation', sub: 'Available via WhatsApp or phone.' }] },
]
